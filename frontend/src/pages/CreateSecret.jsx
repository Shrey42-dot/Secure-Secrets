					...
					<div className="flex items-start gap-4">
						...
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
								Encryption happens <strong>in your browser</strong> before data
								ever reaches our servers. We do not have the encryption key, so
								we cannot read your secrets or view your images even if we
								wanted to.
							</p>
						</div>
					</div>
				...
				<div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
					<div className="flex items-start gap-4">
						...
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
								When you upload images, our system automatically strips hidden{" "}
								<strong>EXIF data</strong> (GPS location, device model,
								timestamp) to protect your anonymity.
							</p>
						</div>
					</div>
				</div>
					...
					<div className="flex items-start gap-4">
						...
						<div>
							...
							<p className="text-xs text-amber-700 dark:text-amber-400 leading-relaxed">
								We do not moderate content as we cannot see it. You are solely
								responsible for the images and text you share. This tool is
								designed for privacy, not for illegal activities.
							</p>
						</div>
					</div>
				</div>
